...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    role: Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    Topik: Attribute.Relation<
      'plugin::users-permissions.user',
      'manyToOne',
      'api::topik.topik'
    >;
    UserJawabans: Attribute.Relation<
      'plugin::users-permissions.user',
      'oneToMany',
...
export interface ApiKelompokKelompok extends Schema.CollectionType {
  collectionName: 'kelompoks';
  info: {
    singularName: 'kelompok';
    pluralName: 'kelompoks';
  ...
  attributes: {
    ...
    pesertas: Attribute.Relation<
      'api::kelompok.kelompok',
      'oneToMany',
      'api::peserta.peserta'
    >;
...
export interface ApiPesertaPeserta extends Schema.CollectionType {
...
export interface ApiSoalSoal extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Topik: Attribute.Relation<
      ...
      'api::topik.topik'
    >;
    pilihan_ganda: Attribute.Component<'list-jawaban.jawaban', true>;
    user_jawabans: Attribute.Relation<
      'api::soal.soal',
      'oneToMany',
      'api::user-jawaban.user-jawaban'
    >;
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::soal.soal', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::soal.soal', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}

export interface ApiTopikTopik extends Schema.CollectionType {
...
export interface ApiUserJawabanUserJawaban extends Schema.CollectionType {
  ...
  attributes: {
    Skor: Attribute.Decimal;
    Soal: Attribute.Relation<
      'api::user-jawaban.user-jawaban',
      'manyToOne',
      'api::soal.soal'
    >;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::kelompok.kelompok': ApiKelompokKelompok;
      'api::peserta.peserta': ApiPesertaPeserta;
      'api::soal.soal': ApiSoalSoal;
      'api::topik.topik': ApiTopikTopik;
      'api::user-jawaban.user-jawaban': ApiUserJawabanUserJawaban;
    }
  }
}
